...
var Alert = function () {
    ...
    return (React__default.createElement(core.Snackbar, __assign({ anchorOrigin: { vertical: "top", horizontal: "right" }, autoHideDuration: 2000 }, snackbarProps, { onClose: onClose, open: state.open }),
